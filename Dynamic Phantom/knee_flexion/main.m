...
% ZYH, 02/02/2013
%
% This is the process of making knee phantom. Codes are in cell
...
%%
% Segmented half cycle, mirror to get another cycle. Do this please.
mirror;
disp('mirror is done');
...
%%
% Generate movie kneePhantom.avi from the data, using polygon-support Fourier transform to
