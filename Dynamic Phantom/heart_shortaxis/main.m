% Cardiac Phantom (short axis)
% ZYH, 02/02/2013
%
% This is the process of making cardiac phantom. Codes are in cell
...
%%
% Generate some fake cycles from segmented data. Do this please.
extending;
disp('extending is done');
...
%%
% Combine partial segmented contours to ROI contours. Do this please.
stitching;
disp('stitching is done');
...
%%
% Generate movie shortaxisPhantom.avi from the data, using polygon-support Fourier transform to
